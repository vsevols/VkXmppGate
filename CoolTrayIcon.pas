...
{$ENDIF}
  ...
  public
    ...
    function ShowBalloonHint(Title, Text: D7String; IconType: TBalloonHintIcon;
...
//        Exit;
    ...
    begin
      StrLCopy(IconData.szTip, D7PChar(D7String(FHint)), SizeOf(IconData.szTip)-1);
...
function TCoolTrayIcon.ShowBalloonHint(Title, Text: D7String; IconType:
    TBalloonHintIcon; TimeoutSecs: TBalloonHintTimeOut): Boolean;
...
begin
  ...
  begin
    ...
    StrLCopy(szInfo, D7PChar(Text), SizeOf(szInfo)-1);
    StrLCopy(szInfoTitle, D7PChar(Title), SizeOf(szInfoTitle)-1);
