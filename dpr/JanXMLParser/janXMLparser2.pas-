...
uses
  ...
  Controls, Forms, Menus, Dialogs,janXPathTokenizer, Math, janstrings, D7Compat;
...
type
  ...
  THash = class
    protected
      ...
      function FFindKey(const Key: D7String; var k, x: integer): boolean;

      {** Add a new key, or change an existing one. Don't call this directly. }
      procedure FSetOrAddKey(const Key: D7String; ItemIndex: integer);
    ...
    public
      ...
      {** Does a key exist? }
      function Exists(const Key: D7String): boolean;

      {** Rename a key. }
      procedure Rename(const Key, NewName: D7String);

      {** Delete a key. }
      procedure Delete(const Key: D7String);
  ...
  TObjectHash = class(THash)
    ...
    protected
      ...
      function FGetItem(const Key: D7String): TObject;

      {** Set or add an item. }
      procedure FSetItem(const Key: D7String; Value: TObject);
    ...
    public
      {** Items property. }
      property Items[const Key: D7String]: TObject read FGetItem
  ...
  TVariableEvent=procedure(sender:Tobject;const VariableName:D7String;var VariableValue:variant;var handled:boolean) of object;
  TXELEvent=procedure(sender:TObject;node:TjanXMLNode2;const Act:D7String) of object;
  TjanXSLSort=record
    pattern:D7String;
  ...
  private
    Fvalue: variant;
    Fname: D7String;
    procedure Setname(const Value: D7String);
    procedure Setvalue(const Value: variant);
  public
  {XML Attribute object}
    property name:D7String read Fname write Setname;
    {Holds the name of the attribute.}
    property value:variant read Fvalue write Setvalue;
    {Holds the D7String value of the attribute}
  ...
  private
    ...
    procedure Setpattern(const Value: D7String);
  ...
  {Helper object to handle QXML expressions to select nodes.}
    ...
    property pattern:D7String read Fpattern write Setpattern;
...
//    Fscan:integer;
    procedure Settext(const Value: D7String);
    procedure Setname(const Value: D7String);
    function getAttribute(index: variant): variant;
    procedure setAttribute(index: variant; const Value: variant);
    procedure AddParsedAttribute(pName,pValue:D7String);
    function getAttributeCount: integer;
    function Getattributename(index: integer): D7String;
    procedure SetParentNode(const Value: TjanXMLNode2);
    function GetID: D7String;
    procedure SetID(const Value: D7String);
    ...
    function getAsText(index: variant): D7String;
   protected
  public
    ...
    property namespace:D7String read Fnamespace;
    ...
    property text:D7String read Ftext write Settext;
    ...
    property attributename[index:integer]:D7String read Getattributename;
    {Provides indexed access to the attribute names.}
    property AsText[index:variant]: D7String read getAsText;
    {Provides indexed access to attributes of the node, converting between floating point value and D7String. Invalid D7Strings are converted to 0}
    property AsFloat[index:variant]: extended read getAsFloat;
    {Provides indexed access to attributes of the node, converting between floating point value and D7String. Invalid strings are converted to 0}
    ...
    property id:D7String read GetID write SetID;
    {Shortcut for attribute['id']}
    property rootNode:TjanXMLNode2 read GetRootNode;
    function hasAttribute(aname:D7String):boolean;
    ...
    function indexOfAttribute(aname:D7String):integer;
    ...
    function deleteAttribute(attributeName:D7String):boolean;overload;
    {Deletes a given attribute by name.}
    function renameAttribute(oldname,newname:D7String):boolean;
    ...
    procedure selectNodes(nodelist: TList; pattern:D7String;single:boolean=false);overload;
    {Adds recursive child nodes that match pattern to nodelist.}
    procedure selectNodes(parser:TjanXMLParser2;nodelist: TList; pattern:D7String;single:boolean=false);overload;
    {Adds recursive child nodes that match pattern to nodelist.
    ...
    function namedChildCount(pname:D7String):integer;
    ...
    function namespaceURI:D7String;
    ...
    function getXELVariable(aname:D7String):TjanXMLNode2;
  ...
  private
    ...
    function getXML: D7String;
    procedure setXML(const Value: D7String); virtual;
    function AsText:D7String;
    ...
    //function cdatacheck(value:D7String):D7String;
    function parse:D7String;
    function parseFragment(pNode:TjanXMLNode2):D7String;
    function parseNode(rootNode,parentNode:TjanXMLNode2):boolean;
    procedure parseAttributes(node:TjanXMLNode2;atts:D7String);
    function parseText(node:TjanXMLNode2): Boolean;
    procedure XMLPut(value: D7String);
    ...
    function getNodeXML(pNode: TjanXMLNode2): D7String;
    procedure setNodeXML(pNode: TjanXMLNode2; const Value: D7String);
  ...
  protected
    ...
    function transformNode_(node:TjanXMLNode2):D7String;
  ...
  public
    ...
    procedure LoadXML(filename:D7String); virtual;
    {Loads an XML document from filename and parses the document into a DOM.}
    procedure SaveXML(filename:D7String);
    ...
    function NodeFromId(pId:D7String):TjanXMLNode2;
    {Returns the node with the given id. Can only be called after IndexNodes}
    function GetNodeByNameAndId(pNodeName, pId:D7String):TjanXMLNode2;
    {Returns the node with the given pNodeName and pId. Can only be called after IndexNodesNamed}
    function DeleteNodeByNameAndId(pNodeName,pId:D7String):boolean;
    {Delete the node with the given pNodeName and id pId. Returns true when succeeded.}
    function AddNodeByNameAndId(pNodeName,pId:D7String;pNode:TjanXMLNode2):boolean;
    ...
    function getXPathParser(pattern:D7String):TjanXPathParser2;
    ...
    function getcomplexType(pType:D7String):TjanXMLNode2;
    {Returns the <xs:complexType> node with name=pType}
    property NodeXML[pNode:TjanXMLNode2]:D7String read getNodeXML write setNodeXML;
    {Parses XML fragment into pNode on write and returns XML document fragment on read }
    property xml:D7String read getXML write setXML;
    {Holds the XML source. Parses on write and returns DOM as text on read.}
    property parseError:D7String read FparseError;
    ...
    {Determines the page size for turbo-speed D7String concatenation. The default = $10000}
  ...
  private
    ...
    procedure setXML(const Value: D7String); override;
    procedure Prepare;
    ...
    procedure TypeWalk(node:TjanXMLNode2;nodepath:D7string);
    function GetNodePath(node:TjanXMLNode2):D7string;
    ...
    procedure ValidateAttributeRestriction(pnode:TjanXMLNode2;pAttributeName:D7string; pAttributeValue:D7string;pRestriction:TjanXMLNode2);
    ...
    procedure ValidateNodeTypeBasic(pnode:TjanXMLNode2;ptype:D7string);
  ...
  public
    ...
    destructor Destroy;override;
    procedure LoadXML(filename:D7string); override;
    ...
    function GetTypeDef(pname:D7string):TjanXMLNode2;
    ...
    function GetAttribute(pnode:TjanXMLNode2;pname:D7string):TjanXMLNode2;
    ...
    function IsValidEnumeration(pNode:TjanXMLNode2;pvalue:D7string):boolean;
    ...
    function GetDocumentation(pnode:TjanXMLNode2):D7string;
    {Returns xs:documentation content of xs:annotation child.}
    procedure ValidateNodeTypeAttribute(pnode, pattributenode: TjanXMLNode2;pAttributeValue:D7string);
    {Validates attribute value. Use before update. Raises an exception when invalid.}
    function GetSchemaAttribute(pnode:TjanXMLNode2;pAttributeName:D7string):TjanXMLNode2;
    {Returns the schema xs:attribute node for the given element pnode and attribute.}
    function GetNewPrimaryKey(pDocumentNode:TjanXMLNode2;pAttributeDef:TjanXMLNode2):D7string;
    ...
    function isclassid(value:D7string):boolean;
...
//    FTokenExpression:string;
    ...
    FCurrentNode: TjanXMLNode2;
    FCurrentList: TList;
    procedure Setsource(const Value: D7string);
...
//    procedure GetElement(sender:Tobject;const VariableName:string;var VariableValue:variant;var handled:boolean);
    procedure GetAttribute(sender:Tobject;const VariableName:D7string;var VariableValue:variant;var handled:boolean);
  ...
  public
    ...
    property Expression:D7string read Fsource write Setsource;
  ...
  function HashThis(const s: D7string): cardinal;
...
procedure THash.Delete(const Key: D7string);
var
  k, x, i: integer;
begin
...
function THash.Exists(const Key: D7string): boolean;
var
...
procedure THash.FSetOrAddKey(const Key: D7string; ItemIndex: integer);
var
  k, x, i: integer;
begin
  { Exists already? }
...
function THash.FFindKey(const Key: D7string; var k, x: integer): boolean;
var
  i: integer;
  h: cardinal;
begin
...
procedure THash.Rename(const Key, NewName: D7string);
var
  k, x, i: integer;
begin
  { Hash has been modified, so disallow Next. }
...
function THash.CurrentKey: D7string;
begin
...
function TObjectHash.FGetItem(const Key: D7string): TObject;
var
  k, x: integer;
begin
...
procedure TObjectHash.FSetItem(const Key: D7string; Value: TObject);
var
  k, x, i: integer;
begin
  if (self.FFindKey(Key, k, x)) then begin
...
function xpElement(node:TjanXMLNode2;aname,avalue:D7string):boolean;
begin
  result:=node.name=aname;
end;

// check the attribute existence
function xpNop(node:TjanXMLNode2;aname,avalue:D7string):boolean;
begin
  result:=false;
end;


function xpAttribute(node:TjanXMLNode2;aname,avalue:D7string):boolean;
begin
  result:=node.indexOfAttribute(aname)<>-1;
end;

// check the attribute=value
function xpAttributeEQ(node:TjanXMLNode2;aname,avalue:D7string):boolean;
begin
  result:=node.indexOfAttribute(aname)<>-1;
  if result then
...
// check the attribute<>value
function xpAttributeNE(node:TjanXMLNode2;aname,avalue:D7string):boolean;
begin
  result:=node.indexOfAttribute(aname)<>-1;
  if result then
    result:=node.attribute[aname]<>avalue;
...
function xpChild(node:TjanXMLNode2;aname,avalue:D7string):boolean;
var
  i,c:integer;
  n:TjanXMLNode2;
begin
...
function xpChildEQ(node:TjanXMLNode2;aname,avalue:D7string):boolean;
var
  i,c:integer;
  n:TjanXMLNode2;
begin
...
// check the presence of a named child with<>value
function xpChildNE(node:TjanXMLNode2;aname,avalue:D7string):boolean;
var
  i,c:integer;
  n:TjanXMLNode2;
begin
...
procedure TjanXMLNode2.selectNodes(nodelist:TList;pattern:D7string;single:boolean=false);
...
function TjanXMLNode2.Getattributename(index: integer): D7string;
begin
  if index<Fattributes.count then
...
function TjanXMLNode2.renameAttribute(oldname, newname: D7string): boolean;
var
  index:integer;
begin
  result:=false;
...
procedure TjanXMLNode2.Setname(const Value: D7string);
var
  p:integer;
begin
  p:=pos(':',value);
...
procedure TjanXMLNode2.Settext(const Value: D7string);
begin
...
function TjanXMLNode2.indexOfAttribute(aname: D7string): integer;
var
  i,c:integer;
begin
  result:=-1;
...
function TjanXMLNode2.hasAttribute(aname: D7string): boolean;
begin
...
function TjanXMLNode2.getChildByID(aid: D7string;descent:boolean=false): TjanXMLNode2;
var
  i,c:integer;
  n:TjanXMLNode2;
begin
...
function TjanXMLNode2.getChildByName(aname: D7string;descent:boolean=false): TjanXMLNode2;
var
  i,c:integer;
  n:TjanXMLNode2;
begin
...
function TjanXMLNode2.transformNode(stylesheet: TjanXMLparser2): D7string;
begin
  result:=stylesheet.transformNode_(self);
end;

procedure TjanXMLNode2.selectNodes(parser: TjanXMLParser2; nodelist: TList;
  pattern: D7string; single: boolean);
var
  i,p,pfs,ppred:integer;
  mc:integer;
  xpp:TjanXPathParser2;
  xplocation,xpstep,predicates,predicate:D7string;
  axis,nodetest:D7string;
...
function TjanXMLNode2.namespaceURI: D7string;
var
  n:TjanXMLNode2;
  ns:D7string;
begin
...
function TjanXMLNode2.forceChildByName(aname: D7string): TjanXMLNode2;
begin
...
function TjanXMLNode2.GetID: D7string;
begin
  result:=attribute['id'];
end;

procedure TjanXMLNode2.SetID(const Value: D7string);
begin
  attribute['id']:=value;
end;

function TjanXMLNode2.getChildByAttribute(AttributeName,
  AttributeValue: D7string): TjanXMLNode2;
var
  i,c:integer;
  n:TjanXMLNode2;
begin
...
function TjanXMLNode2.addChildByName(aname: D7string): TjanXMLNode2;
begin
  result:=TjanXMLNode2.create;
  result.name:=aname;
  addNode(result);
...
function TjanXMLNode2.getChildByPath(apath: D7string): TjanXMLNode2;
var
  tmp, atom:D7string;
  p:integer;
  n:TjanXMLNode2;
...
function TjanXMLNode2.getChildText(pName: D7string): D7string;
var
  xc:TjanXMLNode2;
begin
  result:='';
...
function TjanXMLNode2.forceChildByPath(apath: D7string): TjanXMLNode2;
var
  tmp, atom:D7string;
  p:integer;
  n:TjanXMLNode2;
...
function TjanXMLNode2.getParentByName(aname: D7string): TjanXMLNode2;
var
  n:TjanXMLNode2;
begin
  result:=nil;
...
function TjanXMLNode2.getXELVariable(aname: D7string): TjanXMLNode2;
var
...
function TjanXMLNode2.deleteAttribute(attributeName: D7string): boolean;
var
  index:integer;
...
procedure TjanXMLNode2.getChildrenByName(aname: D7string; nodelist: TList;
  descent: boolean);
var
  i,c:integer;
  n:TjanXMLNode2;
...
procedure TjanXMLNode2.getHtmlOptions(list: Tstringlist; path: D7string);
var
  i,c:integer;
  xn:TjanXMLNode2;
begin
...
function TjanXMLNode2.namedChildCount(pname: D7string): integer;
var
  i,c:integer;
begin
  result:=0;
...
function TjanXMLNode2.getAsText(index: variant): D7string;
var
  tmp:variant;
begin
  tmp:=attribute[index];
...
procedure TjanXMLNode2.AddParsedAttribute(pName, pValue: D7string);
var
  a:TjanXMLAttribute2;
begin
  a:=TjanXMLAttribute2.Create;
...
function TjanXMLParser2.AsText: D7string;
var
  version,encoding:D7string;
begin
  FOutPut:='';
  FXMLSize:=$10000;
  FXMLPosition:=0;
...
function TjanXMLParser2.getXML: D7string;
begin
  result:=AsText;
end;

function TjanXMLParser2.getXPathParser(pattern: D7string): TjanXPathParser2;
var
  index:integer;
  xpp:TjanXPathParser2;
begin
...
procedure TjanXMLParser2.LoadXML(filename: D7string);
begin
...
function TjanXMLParser2.parse:D7string;
var
  src:D7string;
  p,p2:integer;
  atom:D7string;
...
procedure TjanXMLParser2.parseAttributes(node: TjanXMLNode2; atts: D7string);
var
  s,attname,attvalue:D7string;
  p1,p2:integer;
  delim:D7Char;
begin
  s:=trim(atts);
...
var
  p:integer;
  tag,tagname, strAttributes:D7string;
  newnode:TjanXMLNode2;
  bShortCut: boolean;
begin
  fscan:=posstr('<',fxml,fscan);
...
procedure TjanXMLParser2.SaveXML(filename: D7string);
begin
  savestring(filename,self.AsText);
end;

procedure TjanXMLParser2.setXML(const Value: D7string);
begin
  Fxml:=value;
  FparseError:=parse;
end;
...
procedure TjanXMLParser2.XMLPut(value:D7string);
var
  L:integer;
  tmp:D7string;
begin
...
function TjanXMLParser2.transformNode_(node: TjanXMLNode2): D7string;
var
...
var
  v:variant;
  ni,nj:TjanXMLNode2;
  pattern,s1,s2:D7string;
  obi,obc:integer;
  xpp:TjanXPathParser2;

  function safefloat(atext:D7string):double;
  begin
    try
...
function TjanXMLParser2.getNodeXML(pNode: TjanXMLNode2): D7string;
var
  version,encoding:D7string;
begin
  result:='';
...
function TjanXMLParser2.parseFragment(pNode: TjanXMLNode2): D7string;
var
  src:D7string;
  p:integer;
begin
...
function TjanXMLParser2.NodeFromId(pId: D7string): TjanXMLNode2;
begin
...
function TjanXMLParser2.getcomplexType(pType: D7string): TjanXMLNode2;
var
  i,c:integer;
  xn:TjanXMLNode2;
begin
...
function TjanXMLParser2.AddNodeByNameAndId(pNodeName, pId: D7string;
...
procedure TjanXPathParser2.Setpattern(const Value: D7string);
var
  tmp:D7string;
begin
  tmp:=value;
...
procedure TjanXMLAttribute2.Setname(const Value: D7string);
begin
  Fname := Value;
end;
...
procedure TjanXPathExpression2.Setsource(const Value: D7string);
begin
  Fsource := Value;
  SL:=length(FSource);
  parse;
...
procedure TjanXPathExpression2.GetAttribute(sender: Tobject;
  const VariableName: D7string; var VariableValue: variant;
  var handled: boolean);
begin
...
var
  ...
  function parseFloat(s:D7string):D7string;
  var
    i:integer;
  begin
    result:='';
...
var
  xn:TjanXMLNode2;
  XPath,temp,attri, axis, nodeName:D7string;
  locationStep:D7string;
  p:integer;
  descend:boolean;
begin
  if CurrentNode=nil then begin
...
procedure TjanXSDParser2.ValidateNodeTypeAttribute(pnode,
  pattributenode: TjanXMLNode2;pAttributeValue:D7string);
var
  aname,atype, ause,avalue, adefault:D7string;
  mbase:D7string;
...
function TjanXSDParser2.GetAttribute(pnode: TjanXMLNode2;pname:D7string): TjanXMLNode2;
var
  i,c:integer;
  xnc:TjanXMLNode2;
begin
...
function TjanXSDParser2.GetNodePath(node: TjanXMLNode2): D7string;
var
  xn:TjanXMLNode2;
begin
  result:=node.name+'\';
...
function TjanXSDParser2.GetTypeDef(pname: D7string): TjanXMLNode2;
begin
...
procedure TjanXSDParser2.LoadXML(filename: D7string);
begin
  inherited;
  Prepare;
end;
...
procedure TjanXSDParser2.setXML(const Value: D7string);
begin
  inherited;
  Prepare;
end;

procedure TjanXSDParser2.TypeWalk(node: TjanXMLNode2;nodepath:D7string);
var
  mname,mtype:D7string;
  i,c:integer;
...
procedure TjanXSDParser2.ValidateAttributeRestriction(pnode: TjanXMLNode2;
  pAttributeName, pAttributeValue: D7string; pRestriction: TjanXMLNode2);
var
  i,c:integer;
  rname:D7string;
  xnc:TjanXMLNode2;
  EnumMatch:boolean;
  aname, avalue, mbase:D7string;
...
function TjanXSDParser2.GetDocumentation(pnode: TjanXMLNode2): D7string;
var
...
function TjanXSDParser2.GetSchemaAttribute(pnode: TjanXMLNode2;
  pAttributeName: D7string): TjanXMLNode2;
var
  xe,xt,xa:TjanXMLNode2;
  mtype,matype, aname:D7string;
  i,c:integer;
begin
  xe:=GetElement(pnode);
  if xe=nil then
...
function TjanXSDParser2.GetNewPrimaryKey(pDocumentNode,
  pAttributeDef: TjanXMLNode2): D7string;
var
  list:TList;
  i,c:integer;
  matype, mbase:D7string;
  primename:D7string;
  primevalue:integer;
  ...
  function FindAttributeNameByTypeName(pnode:TjanXMLNode2;ptypename:D7string):D7string;
  var
    ia,ca:integer;
    xac:TjanXMLNode2;
  begin
...
function TjanXSDParser2.isclassid(value: D7string): boolean;
var
  guid:TGuid;
begin
  result:=false;
