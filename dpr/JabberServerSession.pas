...
type
  ...
  public
    ...
    function NormalizeJid(AJid: string): string;
...
function TJabberServerSession.NormalizeJid(AJid: string): string;
var
  p: Integer;
begin
  AJid:=Trim(AJid);
...
begin
  ...
  FPresShow := Value;
  dtPresShow:=IncHour(TTimeZone.Local.ToUniversalTime(Now), 3);
  OnPresShowChanged();
