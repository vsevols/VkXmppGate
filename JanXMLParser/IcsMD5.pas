...
const
    MD5Version         = 105;
    CopyRight : String = ' MD5 Message-Digest (c) 1997-2006 F. Piette V1.05 ';
...
function GetMD5(Buffer: Pointer; BufSize: Integer): AnsiString;
function StrMD5(Buffer : AnsiString): AnsiString;
function FileMD5(const Filename: AnsiString) : AnsiString;
